...
## Description
This application is an example of using an API and its coorisponding KEY to retrieve current and forecasted weather for a given city.
...
1. **Clone the Repository**:
   ...
   ```bash
   git clone git@github.com:JoshAskew/Weather-Dashboard.git
